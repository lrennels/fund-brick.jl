...
include(joinpath(dirname(@__FILE__), "components/fund/SocioEconomicComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/PopulationComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/EmissionsComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/GeographyComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ScenarioUncertaintyComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateCO2CycleComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateCH4CycleComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateN2OCycleComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateSF6CycleComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateForcingComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateDynamicsComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/BioDiversityComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ClimateRegionalComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/OceanComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactAgricultureComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactBioDiversityComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactCardiovascularRespiratoryComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactCoolingComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactDiarrhoeaComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactExtratropicalStormsComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactDeathMorbidityComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactForestsComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactHeatingComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactVectorBorneDiseasesComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactTropicalStormsComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactWaterResourcesComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactSeaLevelRiseComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/ImpactAggregationComponent.jl"))
include(joinpath(dirname(@__FILE__), "components/fund/VslVmorbComponent.jl"))
